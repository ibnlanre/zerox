...
import { ErrorBoundary } from "zerox";
...
import { useErrorBoundary } from "zerox";
...
import {withErrorBoundary} from 'zerox'
...
[This blog post](https://kentcdodds.com/blog/use-zerox-to-handle-errors-in-react) shows more examples of how this package can be used, although it was written for the [version 3 API](https://github.com/bvaughn/zerox/releases/tag/v3.1.4).